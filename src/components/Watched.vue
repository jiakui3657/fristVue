<template>
  <div class="mine">
    <div class="title-list">
      <ul class="list-ul">
        <li class="list-li list-rotate">
          <i style="width: 13px;height: 13px;display: inline-block;border: 1px solid #999;margin-top: 10px;cursor: pointer"></i>
        </li>
        <li class="list-li list-rotate">
          <div class="list-box">
            <a>
        ...
        <li class="list-li list-rotate">
          <div class="list-box">
            ...
            <ul>
              <li style="margin-top: 5px;margin-bottom: 5px;" v-for="(item, index) in viewList" :key="index" @click="selectView(index)" :class="index == viewId? 'active' : ''">{{item}}</li>
            </ul>
          </div>
        </li>
        <li class="list-li list-rotate">
    ...
    <div class="project-list" v-if="viewId == 0">
      <ul>
        <li v-for="(item, index) in projectList" :key="index" :id="item.creater.id" v-on:click.stop="projectDetails">
    ...
    <div class="project-form" v-if="viewId == 1" style="padding-top: 40px;">
      <template>
        <el-table
          :data="projectList"
          border
...
export default {
  ...
  methods: {
    jk: function (row, column, cell, event) {
